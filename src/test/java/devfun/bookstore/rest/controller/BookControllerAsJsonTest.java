...
public class BookControllerAsJsonTest {
    ...
    public void testCreateBook() throws Exception{
        Book createdBook = new Book(100L, "책이름", "성현", "소설", new Date());
        String content = new ObjectMapper().writeValueAsString(createdBook);
    ...
    public void testUpdateBook() throws Exception{
        Book updateBook = new Book(3L, "어스시의 마법사", "어슐러 K. 르권", "판타지소설", new Date());
        // Java 2 Json (Jackson의 ObjectMapper를 사용한다.)
        ...
        this.mockMvc.perform(requestBuilder).andDo(print())
                ...
                .andExpect(jsonPath("$.creator", is("어슐러 K. 르권")));
    }
